...
import pageObjects.MentorsRegistrationPage;

public class MentorRegistrationStepdefs extends BrowserDriver {

    MentorsRegistrationPage  mrp = new MentorsRegistrationPage(driver);
